...
<html>
    <head>
        <title>ResamVi | Code, Edit, Bake</title>
    ...
    <body>
        ...
        <div class="container-fluid" style="padding:0;">    
                ...
                <div id="horizontal-alignment">
                    ...
                    <div class="row" id="iconRow">
                        <div class="col-md-4 col-md-offset-4" id="iconContainer">
                            ...
                            <a id="trophy" style="cursor: pointer;">
                                    <img src="img/icons/progress48.png" alt="trophy" class="icons">
                            </a>
                        ...
                        <div class="col-md-4 col-md-offset-4" id="iconContainer">
                            <img src="img/arrowDownSmall.png" alt="arrow down" id="smallarrow" style="visibility:hidden;">
                        </div>
                        
                        <div class="col-md-4 col-md-offset-4" id="subiconContainer">
                            
                            <div id="vertical">
                                <a href="https://www.hackerrank.com/ResamVi" style="visibility:hidden;">
                                    <img id="icon1" src="img/icons/hackerrank48.png" alt="hackerrank" class="subicons">
                                </a>
                                <a href="https://www.codingame.com/profile/1d2bfec1d536931514190d98cd20a8369171221" style="visibility:hidden;">
                                    <img id="icon2" src="img/icons/codingame48.png" alt="codingame" class="subicons">
                                </a>
                                <a href="http://codeforces.com/profile/ResamVi" style="visibility:hidden;">
                                    <img id="icon3" src="img/icons/codeforces48.png" alt="codeforces" class="subicons">
                                </a>
                                <a href="https://www.codewars.com/users/ResamVi" style="visibility:hidden;">
                                    <img id="icon4" src="img/icons/codewars48.png" alt="codewars" class="subicons">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <hr class="separate" style="padding:0px;margin:auto;">
            
            <div class="sandwich">&#9776;</div>
            
            
            <form class="form center-block search">
                <div class="col-md-4 col-md-offset-4 text-center">
                    ...
                    <div style="margin-top:5px;">
                        ...
                        <div class="checkbox-inline">
                          <label style="font-weight: normal">
                            <input type="checkbox" id="baking" checked>
                            Backen
                          </label>
                        </div>
                        <div class="checkbox-inline">
            ...
            <!--
            What to do to implement filters?
            Clear out the whole blog-entries div and re-print everything
